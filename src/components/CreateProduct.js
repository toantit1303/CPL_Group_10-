...
export default function CreateProduct({ categories = [] }) {
    ...
    const handleSubmit = async (e) => {
        ...
        if (isNaN(parseInt(formData.quantity)) || parseInt(formData.quantity) <= 0) {
            errors.quantity = "Quantity must be a non-negative integer and larger than 0.";
        }
    ...
    return (
        <Container fluid>
            ...
            <Row>
                <Col>
                    <Button><Link style={{ textDecoration: "none", color: "white" }} to="/admin/products">Back to products list</Link></Button>
                </Col>
            </Row>
            <Row>
                <Col md={3} style={{ textAlign: 'center', marginTop: "20px" }}>
                    <img
                        src={imagePreview}
                        alt="Preview"
                        style={{
